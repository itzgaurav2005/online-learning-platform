...
6. How you'd scale this system
7. Security measures implemented
8. How progress tracking works
9. The enrollment workflow
...
A: I use JWT tokens stored in HTTP-only cookies for security. The authenticate middleware verifies the token on protected routes.

**Q: How is access control implemented?**
A: Through role-based middleware that checks if the user's role matches the required permissions for each route.

**Q: Why separate modules and lessons?**
A: It provides better course organization, allows reordering, and makes it easier to track progress at a granular level.

**Q: How do you prevent students from accessing unpublished courses?**
A: Courses must have both isPublished and isApproved set to true to appear in the public course list.

**Q: How would you scale this?**
A: Add caching (Redis), implement CDN for static assets, database read replicas, message queues for async tasks, and horizontal scaling with load balancers.
